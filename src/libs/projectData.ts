...
const projectInfo = [
  {
    ...
    img: [{ src: require('../images/RiverText.jpg'), title: 'RiverText being used on a satelite phone' }],
  ...
  },
  {
    ...
    img: [{ src: require('../images/Intercom.gif'), title: 'Clear Monitoring closing tickets' }, { src: 'https://github.com/SeanMcTernan/SeanMcTernan/blob/master/ReadMe_Images/Clear_Monitoring/Clear_Monitoring_Sample.png?raw=true', title: 'Cli for Clear Monitoring' }],
  ...
  },
  {
    ...
    img: [{ src: require('../images/Drag&Drop.gif'), title: 'Using the note taking app' }, { src: 'https://github.com/SeanMcTernan/SeanMcTernan/raw/master/ReadMe_Images/TypeScript-Drag-And-Drop/TS_Drag&Drop_Cap_1.png?raw=true', title: 'App main screen' }],
